...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['change_password'])) {
    ...
    if (password_verify($current_password, $provider['password'])) {
        if ($new_password === $confirm_password) {
            ...
            $update_sql = "UPDATE service_providers SET password = ? WHERE id = ?";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_notifications'])) {
    ...
    $update_sql = "UPDATE service_providers SET 
                  ...
                  WHERE id = ?";
    $stmt = $conn->prepare($update_sql);
    $stmt->bind_param("iii", $email_notifications, $sms_notifications, $provider_id);
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="service-provider_settings.html" class="nav-link active">
            ...
            <div class="settings-container">
                ...
                <div class="tab-content active" id="account-tab">
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <input type="email" id="account-email" class="form-control" value="<?php echo htmlspecialchars($provider['email']); ?>" readonly>
                        </div>
                        <div class="form-group">
                            <label for="account-phone">Phone Number</label>
                            <input type="tel" id="account-phone" class="form-control" value="<?php echo htmlspecialchars($provider['phone']); ?>" readonly>
                        </div>
                        <div class="form-group">
                            <label for="account-type">Service Type</label>
                            <input type="text" id="account-type" class="form-control" value="<?php echo ucfirst($provider['service_type']); ?>" readonly>
                        </div>
                    </form>
                </div>
                ...
                <div class="tab-content" id="security-tab">
                    ...
                    <div class="security-info">
                        <h4>Security Tips</h4>
                        <p><i class="fas fa-check-circle" style="color: var(--success-color);"></i> Use a strong, unique password that you don't use elsewhere.</p>
                        <p><i class="fas fa-check-circle" style="color: var(--success-color);"></i> Never share your password with anyone.</p>
                        <p><i class="fas fa-check-circle" style="color: var(--success-color);"></i> Change your password regularly for better security.</p>
                    </div>
                </div>
            </div>
        </main>
