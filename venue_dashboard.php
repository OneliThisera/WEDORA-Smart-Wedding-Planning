...
<head>
    ...
    <title>Wedora - Venue Dashboard</title>
...
<body>
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="nav-menu">
                <li class="nav-item"><a href="../venue_dashboard.php" class="nav-link active"><i class="fas fa-tachometer-alt"></i><span>Venue Dashboard</span></a></li>
