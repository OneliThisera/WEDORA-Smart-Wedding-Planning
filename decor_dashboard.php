...
<head>
    ...
    <title>Wedora - Decor Dashboard</title>
        ...
        <aside class="sidebar">
            <div class="sidebar-header">
                ...
                <div class="service-type">
                    ...
                    <span>Decor Provider</span>
                </div>
            </div>
            <ul class="nav-menu">
                <li class="nav-item"><a href="decor_dashboard.php" class="nav-link active"><i class="fas fa-tachometer-alt"></i><span>Decor Dashboard</span></a></li>
            ...
            <div class="top-bar">
                ...
                <div class="user-profile">
                    ...
                    <div class="user-info">
                        ...
                        <div class="user-role">Decor Provider</div>
                    </div>
