...
<head>
    ...
    <title>Wedora - Music Dashboard</title>
...
<body>
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="nav-menu">
                <li class="nav-item"><a href="../music_dashboard.php" class="nav-link active"><i class="fas fa-tachometer-alt"></i><span>Music Dashboard</span></a></li>
            ...
            <div class="top-bar">
                ...
                <div class="user-profile">
                    ...
                    <div class="user-info">
                        ...
                        <div class="user-role">Music Provider</div>
                    </div>
