...
<head>
    ...
    <title>Wedora - Catering  Dashboard</title>
        ...
        <aside class="sidebar">
            <div class="sidebar-header">
                ...
                <div class="service-type">
                    ...
                    <span>Catering Provider</span>
                </div>
            </div>
            <ul class="nav-menu">
                <li class="nav-item"><a href="../catering_dashboard.php" class="nav-link active"><i class="fas fa-tachometer-alt"></i><span>Catering  Dashboard</span></a></li>
            ...
            <div class="top-bar">
                ...
                <div class="user-profile">
                    ...
                    <div class="user-info">
                        ...
                        <div class="user-role">Catering  Provider</div>
                    </div>
