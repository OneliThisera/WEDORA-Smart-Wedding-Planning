...
<head>
    ...
    <title>Wedora -Genaral Dashboard</title>
        ...
        <aside class="sidebar">
            <div class="sidebar-header">
                ...
                <div class="service-type">
                    ...
                    <span>Genaral Provider</span>
                </div>
            </div>
            <ul class="nav-menu">
                <li class="nav-item"><a href="../genaral_dashboard.php" class="nav-link active"><i class="fas fa-tachometer-alt"></i><span>Genaral Dashboard</span></a></li>
            ...
            <div class="top-bar">
                ...
                <div class="user-profile">
                    ...
                    <div class="user-info">
                        ...
                        <div class="user-role">Genaral Provider</div>
                    </div>
